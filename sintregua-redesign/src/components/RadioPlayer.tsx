    ...
    <>
      ...
      <section className="fixed bottom-0 left-0 right-0 z-[100] bg-neutral-dark border-t-2 border-levante-dorado shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
        ...
        {isLoading && isIOS && audioDelay > 0 && (
          <div className="absolute inset-0 bg-black/90 flex items-center justify-center z-10 px-4">
            <div className="flex items-center gap-3">
              <div className="animate-spin w-5 h-5 border-2 border-white/30 border-t-levante-dorado rounded-full shrink-0" />
              <p className="text-white text-sm">Aplicando retardo...</p>
        ...
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between gap-4">
              ...
              {showDelayMenu && (
                <>
                  ...
                  <div className="absolute bottom-full mb-2 left-0 sm:right-0 sm:left-auto bg-neutral-dark border border-white/20 rounded-lg shadow-xl overflow-hidden min-w-[200px] z-50 relative">
                    ...
                    {/* Footer con tip específico para iOS */}
                    {isIOS && audioDelay > 0 && (
            ...
            {/* Control de Volumen - Solo en no-iOS (iOS no permite controlar volumen programáticamente) */}
            {!isIOS && (
              <>
                {/* Desktop: Slider visible */}
                ...
                {/* Móvil: Botón con slider desplegable */}
