...
import { ABOUT_TEXT, IMAGES, SOCIAL_LINKS, COMPANY_INFO } from "@/lib/constants";
    ...
    <main className="min-h-screen bg-neutral-offwhite">
      ...
      <section className="py-20 lg:py-28 bg-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 lg:px-8">
          ...
          <div className="mb-16">
            <h3 className="font-display font-bold text-xl text-neutral-dark mb-8 text-center">
              Conoce al equipo
            </h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Carlos Ayats */}
              <div className="group p-6 bg-gradient-to-br from-levante-azul to-levante-azul-deep rounded-2xl text-white hover:shadow-glow-azul transition-all duration-300 hover:-translate-y-1">
                ...
                <h4 className="font-display font-bold text-lg mb-2">Carlos Ayats</h4>
                <p className="text-white/70 text-sm">Periodista valenciano y fundador de Sin Tregua desde 2006</p>
              </div>

              {/* Jorge Benavent */}
              <div className="group p-6 bg-neutral-offwhite rounded-2xl hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 border border-neutral-light">
                <div className="w-12 h-12 bg-levante-dorado/10 rounded-full flex items-center justify-center mb-4 group-hover:bg-levante-dorado/20 transition-colors">
                  <svg className="w-6 h-6 text-levante-dorado" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h4 className="font-display font-bold text-lg text-neutral-dark mb-2">Jorge &quot;El Maestro&quot; Benavent</h4>
                <p className="text-neutral-muted text-sm">Humor único e incomparable</p>
              </div>

              {/* Jose Lacueva */}
              <div className="group p-6 bg-neutral-offwhite rounded-2xl hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 border border-neutral-light">
                <div className="w-12 h-12 bg-levante-granate/10 rounded-full flex items-center justify-center mb-4 group-hover:bg-levante-granate/20 transition-colors">
                  <svg className="w-6 h-6 text-levante-granate" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                  </svg>
                </div>
                <h4 className="font-display font-bold text-lg text-neutral-dark mb-2">Jose &quot;El Profe&quot; Lacueva</h4>
                <p className="text-neutral-muted text-sm">El mejor comentarista de España con sabiduría balompédica</p>
              </div>

              {/* Álvaro Haro */}
              <div className="group p-6 bg-neutral-offwhite rounded-2xl hover:shadow-card-hover transition-all duration-300 hover:-translate-y-1 border border-neutral-light">
                <div className="w-12 h-12 bg-levante-azul/10 rounded-full flex items-center justify-center mb-4 group-hover:bg-levante-azul/20 transition-colors">
                  <svg className="w-6 h-6 text-levante-azul" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                  </svg>
                </div>
                <h4 className="font-display font-bold text-lg text-neutral-dark mb-2">Álvaro Haro</h4>
              ...
              <div className="group p-6 bg-gradient-to-br from-levante-granate to-levante-granate-deep rounded-2xl text-white hover:shadow-glow-granate transition-all duration-300 hover:-translate-y-1 flex flex-col items-center justify-center text-center">
                <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center mb-4">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                  </svg>
                </div>
                <h4 className="font-display font-bold text-lg mb-2">¡Y tú!</h4>
                <p className="text-white/70 text-sm">Únete a nuestra comunidad granota</p>
              </div>
            </div>
          </div>
